...
if(isset($_POST['submit']))
  {
$stufftitle=$_POST['stufftitle'];
$type=$_POST['typename'];
$stuffoverview=$_POST['stuffoverview'];
...
$sql="update tblstuff set StuffTitle=:stufftitle,StuffType=:type,StuffOverview=:stuffoverview,PricePerDay=:priceperday where id=:id ";
$query = $dbh->prepare($sql);
$query->bindParam(':stufftitle',$stufftitle,PDO::PARAM_STR);
$query->bindParam(':type',$type,PDO::PARAM_STR);
$query->bindParam(':stuffoverview',$stuffoverview,PDO::PARAM_STR);
...
<head>
	...
	<title>Kentingan Rental Portal | Admin Edit Stuff Info</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Stuff</h2>
...
<?php 
$id=intval($_GET['id']);
$sql ="SELECT tblstuff.*,tbltype.TypeName,tbltype.id as tid from tblstuff join tbltype on tbltype.id=tblstuff.StuffType where tblstuff.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<label class="col-sm-2 control-label">Stuff Title<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="stufftitle" class="form-control" value="<?php echo htmlentities($result->StuffTitle)?>" required>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Stuff Overview<span style="color:red">*</span></label>
<div class="col-sm-10">
<textarea class="form-control" name="stuffoverview" rows="3" required><?php echo htmlentities($result->StuffOverview);?></textarea>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-4">
Image 1 <img src="img/stuffimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 1</a>
</div>
<div class="col-sm-4">
Image 2<img src="img/stuffimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 2</a>
</div>
<div class="col-sm-4">
Image 3<img src="img/stuffimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
...
<div class="form-group">
<div class="col-sm-4">
Image 4<img src="img/stuffimages/<?php echo htmlentities($result->Vimage4);?>" width="300" height="200" style="border:solid 1px #000">
...
<img src="img/stuffimages/<?php echo htmlentities($result->Vimage5);?>" width="300" height="200" style="border:solid 1px #000">
